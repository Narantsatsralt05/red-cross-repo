...
export const Registered = ({ e }) => {
  ...
  return (
    <Stack width="100%" height="100%" bg="#FAFAFA" justifyContent="space-between" direction="column">
      ...
      >
        <Stack width="14%">
          <Text type="T1">Регистрийн дугаар</Text>
        </Stack>
        <Stack width="12%">
          <Margin size={[0, 0, 0, 23]}>
            <Text type="T1">Овог</Text>
          </Margin>
        </Stack>
        <Stack width="11%">
          <Text type="T1">Нэр</Text>
        </Stack>
        <Stack width="5%">
          <Text type="T1">Нас</Text>
        </Stack>
        <Stack width="7%">
          <Text type="T1">Хүйс</Text>
        </Stack>
        <Stack width="18%">
          <Text type="T1">Төрөл</Text>
        </Stack>
        <Stack width="11%">
          <Text type="T1">Утас</Text>
        </Stack>
        <Stack width="11%">
          <Text type="T1">Элссэн огноо</Text>
        </Stack>
        <Stack width="10%">
              ...
              <Stack width="100%" height="190%" bg="white" justifyContent="space-between">
                ...
                <Stack width="12%" alignItems="center">
                  <Margin size={[0, 0, 0, 30]}>
                    <Text type="T2">Нямсамбуу-Cайхан</Text>
                  </Margin>
                </Stack>
                <Stack width="11%" alignItems="center">
                  <Text type="T2">Даваа-Самбуу</Text>
                </Stack>
                <Stack width="5%" alignItems="center">
                  <Text type="T2">28</Text>
                </Stack>
                <Stack width="7%" alignItems="center">
                  <Text type="T2">эрэгтэй</Text>
                </Stack>
                  ...
                  <Border borderRadius="5px" borderColor={color.secondary.lightblue}>
                    <Stack bg={color.secondary.lightblue}>
                      <Padding size={[1, 10, 1, 10]}>
                        <Text type="T2">Алтан гишүүн</Text>
                      </Padding>
                    </Stack>
                  </Border>
                  <Margin size={[0, 0, 0, 10]}>
                ...
                <Stack width="11%" alignItems="center">
                  <Text type="T2">88109325</Text>
                </Stack>
                <Stack width="11%" alignItems="center">
                  <Text type="T2">2018.05.01</Text>
                </Stack>
