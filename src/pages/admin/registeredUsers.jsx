...
export const Registeredusers = () => {
    return <Stack  bg={color.primary.background} width="100vw" height="100vh" direction="column" justifyContent="space-between">
        <Stack width="100%" height="13%" direction="column">
        <Header></Header>
        <Stack bg={color.secondary.lightgrey} width="100vw" height="6vh" style={{boxShadow:"0px  13px  10px  -15px  #111"}}>
        ...
        <Stack bg={color.primary.background} width="100vw" height="86vh" justifyContent="space-evenly" >
            <Stack  bg={color.secondary.lightgrey} width="4vw" height="100%" style={{boxShadow:"13px  0px  10px  -15px  #111"}} direction="column"justifyContent="space-between">
